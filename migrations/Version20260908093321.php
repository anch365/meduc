 ...
 */
final class Version20260908093321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE affectation ADD enseignant_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_F4DD61D3E455FCC0 ON affectation (enseignant_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_F4DD61D3E455FCC0 ON affectation');
        $this->addSql('ALTER TABLE affectation DROP enseignant_id');
